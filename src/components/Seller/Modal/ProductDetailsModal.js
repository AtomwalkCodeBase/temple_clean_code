...
import { X, ChevronLeft, ChevronRight, Edit, Plus } from 'lucide-react';
...
<ActionsContainer>
                            ...
                            <Button className="primary" onClick={() => handleVariationNavigation(productData)}>
                                 <Plus size={18} />
                                 {productData.variations && productData.variations.length > 0 ? "Edit" : "Add"} Variation
                             </Button>
                             <Button className="secondary" onClick={() => navigate("/seller-EditProduct", { state: { productData} })}>
                                 <Edit size={18} />
                                 Edit Product
                             </Button>
                        </ActionsContainer>
